...
| --- | --- | --- | --- | --- | --- | --- |
| Compare jCodeMunch and Astrograph | In progress | `codex/jcodemunch-benchmark` | `.worktrees/jcodemunch-benchmark` | `origin/main` at `e009ac5` | Deterministic MCP: 3/3 each; fresh agents: 3/3 each; report records token, call, latency, index, and discarded-run evidence | Run full verification and release decision, then push and merge the documented comparison while retaining the remote branch |
