...
| --- | --- | --- | --- | --- | --- | --- |
| Establish the P1 fast, observable, resumable workflow | Active | `codex/resumable-workflow` | `.worktrees/repair-stale-runtime-discovery` | `origin/main` at `13c35d9` | Opt-in profiling and fast gate pass focused checks; three-run cold-index median improved from 52.3s to 21.4s | Finish preservation-first cleanup, full verification, release decision, and managed-runtime proof |
