...
It reports the retained time window, successful and failed calls, total and
...
metric: it shows the exact baseline, returned, and saved tokens across CLI and
MCP responses that provide it.
