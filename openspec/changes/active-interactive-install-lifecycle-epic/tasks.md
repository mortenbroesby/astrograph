...
> Migrated from [the legacy active tracker](../../../specs-legacy/implementation/active/11_interactive-install-lifecycle-epic.md). The checkbox state below is authoritative going forward.
...
- [Comforting Install Experience](../../../specs-legacy/implementation/active/2_comforting-global-install-experience.md)
  and [Guided Install and Refresh Hooks](../../../specs-legacy/implementation/active/3_guided-install-and-refresh-hooks.md)
