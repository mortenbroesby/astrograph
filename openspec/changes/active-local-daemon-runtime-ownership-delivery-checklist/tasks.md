...
> Migrated from [the legacy active tracker](../../../specs-legacy/implementation/active/5_local-daemon-runtime-ownership-delivery-checklist.md). The checkbox state below is authoritative going forward.
...
>
> **Decision:** [ADR-009](../../../specs-legacy/architecture/adrs.md#adr-009-use-one-user-local-daemon-for-repository-runtime-ownership)
