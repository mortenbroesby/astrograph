...
> Migrated from [the legacy active tracker](../../../specs-legacy/implementation/active/12_pre-v1-clean-install-contract-epic.md). The checkbox state below is authoritative going forward.
...
the [Interactive Install Lifecycle Epic](../../../specs-legacy/implementation/active/11_interactive-install-lifecycle-epic.md).
...
extending it. The completed [pre-v1 cache cleanup](../../../specs-legacy/implementation/closed/pre-v1-cache-codebase-cleanup-delivery-checklist.md)
