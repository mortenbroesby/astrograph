...
> Migrated from [the legacy active tracker](../../../specs-legacy/implementation/active/7_repository-structure-cleanup-epic.md). The checkbox state below is authoritative going forward.
