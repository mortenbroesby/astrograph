...
> Migrated from [the legacy active tracker](../../../specs-legacy/implementation/active/10_runtime-acceleration-epic.md). The checkbox state below is authoritative going forward.
...
- [ ] 0.1 Confirm the delivered branch, pull request, and release evidence, then archive this still-active legacy record.
...
[local-daemon checklist](../../../specs-legacy/implementation/active/5_local-daemon-runtime-ownership-delivery-checklist.md)
