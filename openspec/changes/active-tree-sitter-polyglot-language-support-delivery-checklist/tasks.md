...
> Migrated from [the legacy active tracker](../../../specs-legacy/implementation/active/1_tree-sitter-polyglot-language-support-delivery-checklist.md). The checkbox state below is authoritative going forward.
