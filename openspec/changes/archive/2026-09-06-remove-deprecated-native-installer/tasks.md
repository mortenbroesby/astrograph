...
- [x] 3.3 Review and secret-scan the minimal diff, commit and push the branch, verify exact-head required CI, merge through GitHub, close issue #125 with the delivered evidence, and archive the completed OpenSpec change.
