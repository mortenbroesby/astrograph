...
> Migrated from [the legacy planned tracker](../../../specs-legacy/implementation/planned/3_2_windows-filesystem-storage-portability-delivery-checklist.md). The checkbox state below is authoritative going forward.
...
> **Story:** 3 of the [Remaining Delivery Epic](../../../specs-legacy/implementation/planned/3_remaining-delivery-epic.md)
>
