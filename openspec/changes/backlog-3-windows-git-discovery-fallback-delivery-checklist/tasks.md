...
> Migrated from [the legacy planned tracker](../../../specs-legacy/implementation/planned/3_3_windows-git-discovery-fallback-delivery-checklist.md). The checkbox state below is authoritative going forward.
...
> **Story:** 4 of the [Remaining Delivery Epic](../../../specs-legacy/implementation/planned/3_remaining-delivery-epic.md)
>
