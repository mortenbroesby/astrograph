...
> Migrated from [the legacy planned tracker](../../../specs-legacy/implementation/planned/3_4_windows-cli-mcp-package-invocation-delivery-checklist.md). The checkbox state below is authoritative going forward.
...
> **Story:** 5 of the [Remaining Delivery Epic](../../../specs-legacy/implementation/planned/3_remaining-delivery-epic.md)
>
