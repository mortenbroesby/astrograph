...
> Migrated from [the legacy planned tracker](../../../specs-legacy/implementation/planned/3_6_windows-ci-documentation-release-gate-delivery-checklist.md). The checkbox state below is authoritative going forward.
...
> **Story:** 7 of the [Remaining Delivery Epic](../../../specs-legacy/implementation/planned/3_remaining-delivery-epic.md)
>
