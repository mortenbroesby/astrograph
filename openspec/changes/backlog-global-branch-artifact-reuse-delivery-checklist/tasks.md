...
> Migrated from [the legacy planned tracker](../../../specs-legacy/implementation/planned/5_global-branch-artifact-reuse-delivery-checklist.md). The checkbox state below is authoritative going forward.
...
> **Epic:** [High-Impact Product Follow-Ups Epic](../../../specs-legacy/implementation/planned/4_high-impact-followups-epic.md), Story 1
>
