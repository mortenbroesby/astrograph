...
> Migrated from [the legacy planned tracker](../../../specs-legacy/implementation/planned/6_global-install-and-cache-deferred-stories.md). The checkbox state below is authoritative going forward.
...
> **Epic:** [Global Install and Cache Epic](../../../specs-legacy/implementation/closed/global-install-and-cache-epic.md)
>
