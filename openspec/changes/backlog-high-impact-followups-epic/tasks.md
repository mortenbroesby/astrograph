...
> Migrated from [the legacy planned tracker](../../../specs-legacy/implementation/planned/4_high-impact-followups-epic.md). The checkbox state below is authoritative going forward.
...
>
> **Builds on:** the completed [Global Install and Cache Epic](../../../specs-legacy/implementation/closed/global-install-and-cache-epic.md),
> [Branch-Aware Incremental Index Epic](../../../specs-legacy/implementation/closed/branch-aware-incremental-index-epic.md),
> and [Astrograph Feedback Consolidation Epic](../../../specs-legacy/implementation/closed/astro-feedback-epic.md).
> It complements—rather than replaces—the parked [Remaining Delivery Epic](../../../specs-legacy/implementation/planned/3_remaining-delivery-epic.md)
> and [Precision Retrieval and Agent Experience Epic](../../../specs-legacy/implementation/closed/precision-retrieval-agent-experience-epic.md).
...
[delivery checklist](../../../specs-legacy/implementation/planned/5_global-branch-artifact-reuse-delivery-checklist.md).
...
**Status:** Closed — a stale globally installed package lacked the expected
...
[closed delivery checklist](../../../specs-legacy/implementation/closed/global-install-health-recovery-delivery-checklist.md).
...
[delivery checklist](../../../specs-legacy/implementation/closed/global-checkout-cache-transparency-delivery-checklist.md).
...
[provenance checklist](../../../specs-legacy/implementation/closed/provenance-first-symbol-contract-delivery-checklist.md)
and [ranking checklist](../../../specs-legacy/implementation/closed/deterministic-lexical-ranking-delivery-checklist.md).
...
**Scope:** Select and execute Stories 1–2 of the
  [Precision Retrieval and Agent Experience Epic](../../../specs-legacy/implementation/closed/precision-retrieval-agent-experience-epic.md):
...
[delivery checklist](../../../specs-legacy/implementation/closed/token-budgeted-task-context-delivery-checklist.md).
...
[Remaining Delivery Epic](../../../specs-legacy/implementation/planned/3_remaining-delivery-epic.md) is release
...
appropriate unchecked item in the [Remaining Delivery Epic](../../../specs-legacy/implementation/planned/3_remaining-delivery-epic.md):
...
[delivery checklist](../../../specs-legacy/implementation/closed/pain-free-global-install-delivery-checklist.md).
...
[delivery checklist](../../../specs-legacy/implementation/closed/global-copilot-cli-delivery-checklist.md).
...
compatibility/package-smoke CI passed. See the
[delivery checklist](../../../specs-legacy/implementation/closed/pre-v1-cache-codebase-cleanup-delivery-checklist.md).
...
[research checklist](../../../specs-legacy/implementation/closed/tokenizer-estimator-research-delivery-checklist.md).
...
`d432b6a`. See the [closed delivery checklist](../../../specs-legacy/implementation/closed/mcp-tool-surface-core-delivery-checklist.md)
...
[Story 5: Small MCP Core and Guided Routing](../../../specs-legacy/implementation/closed/precision-retrieval-agent-experience-epic.md#story-5--small-mcp-core-and-guided-routing).
...
See the [delivery checklist](../../../specs-legacy/implementation/closed/filetype-support-coverage-delivery-checklist.md).
