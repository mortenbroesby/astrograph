...
> Migrated from [the legacy planned tracker](../../../specs-legacy/implementation/planned/1_node-20-to-24-runtime-compatibility-epic.md). The checkbox state below is authoritative going forward.
...
> now the active [WASM Parser Runtime Migration](../../../specs-legacy/implementation/active/11_wasm-parser-runtime-migration.md).
