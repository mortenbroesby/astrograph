...
> Migrated from [the legacy planned tracker](../../../specs-legacy/implementation/planned/2_npm-module-adoption-epic.md). The checkbox state below is authoritative going forward.
...
- [ ] 0.1 Select the next incomplete story from the preserved plan before implementation.

## Preserved Plan


> **Status:** Slice A complete — Story 2 is complete in the
> [closed semver delivery checklist](../../../specs-legacy/implementation/closed/npm-module-semver-delivery-checklist.md),
> and Story 3 is complete in the
> [closed registry-lookup delivery checklist](../../../specs-legacy/implementation/closed/npm-module-registry-lookup-delivery-checklist.md).
> The [package-confidence CI-cost review](../../../specs-legacy/implementation/planned/4_npm-module-package-confidence-cost-review-checklist.md)
...
[`../closed/npm-module-registry-lookup-delivery-checklist.md`](../../../specs-legacy/implementation/closed/npm-module-registry-lookup-delivery-checklist.md).
