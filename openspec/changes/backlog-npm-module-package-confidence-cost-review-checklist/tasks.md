...
> Migrated from [the legacy planned tracker](../../../specs-legacy/implementation/planned/4_npm-module-package-confidence-cost-review-checklist.md). The checkbox state below is authoritative going forward.
...
> [npm-module adoption epic](../../../specs-legacy/implementation/planned/2_npm-module-adoption-epic.md). User value from
