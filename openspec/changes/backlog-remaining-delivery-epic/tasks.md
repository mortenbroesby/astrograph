...
> Migrated from [the legacy planned tracker](../../../specs-legacy/implementation/planned/3_remaining-delivery-epic.md). The checkbox state below is authoritative going forward.
...
> [Astrograph Feedback Consolidation](../../../specs-legacy/implementation/closed/astro-feedback-epic.md),
> [Branch-Aware Incremental Index](../../../specs-legacy/implementation/closed/branch-aware-incremental-index-epic.md),
> [Node 22 Compatibility](../../../specs-legacy/implementation/closed/node-22-compatibility-epic.md), and
> [Windows Platform Support](../../../specs-legacy/implementation/closed/windows-platform-support-epic.md).
...
separate, higher-priority [Release on Main Merge checklist](../../../specs-legacy/implementation/planned/0_release-on-main-merge-delivery-checklist.md)
...
[Staff Engineer Review Delivery Checklist](../../../specs-legacy/implementation/closed/staff-engineering-review-delivery-checklist.md)
...
**Delivery checklist:**
[Windows Compatibility Audit Delivery Checklist](../../../specs-legacy/implementation/planned/3_1_windows-compatibility-audit-delivery-checklist.md)
...
**Delivery checklist:**
[Windows Filesystem and Storage Portability Delivery Checklist](../../../specs-legacy/implementation/planned/3_2_windows-filesystem-storage-portability-delivery-checklist.md)
...
**Delivery checklist:**
[Windows Git Discovery and Fallback Delivery Checklist](../../../specs-legacy/implementation/planned/3_3_windows-git-discovery-fallback-delivery-checklist.md)
...
**Delivery checklist:**
[Windows CLI, MCP, and Package Invocation Delivery Checklist](../../../specs-legacy/implementation/planned/3_4_windows-cli-mcp-package-invocation-delivery-checklist.md)
...
**Delivery checklist:**
[Windows Watch and Refresh Reliability Delivery Checklist](../../../specs-legacy/implementation/planned/3_5_windows-watch-refresh-delivery-checklist.md)
...
**Delivery checklist:**
[Windows CI, Documentation, and Release Gate Delivery Checklist](../../../specs-legacy/implementation/planned/3_6_windows-ci-documentation-release-gate-delivery-checklist.md)
