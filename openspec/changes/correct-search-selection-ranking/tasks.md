...
- [ ] 1.1 Add the smallest public engine fixture that proves the current scoped
...
- [ ] 2.1 Correct the BM25 weight vector for the complete `symbol_search`
  column order in `src/retrieval.ts` and verify the focused name-versus-summary
  ordering assertion passes.
- [ ] 2.2 Page deterministic FTS results until 400 in-scope candidates or
...
- [ ] 2.3 Make the existing heuristic score the primary ordering key and BM25
