...
starting with Story 3's isolated JSON/AGC1/AGC2 benchmark harness. Treat the
current packed-row AGC2 implementation as a baseline experiment only; strict
JSON and AGC1 remain the release-safe fallback until the epic's corpus
