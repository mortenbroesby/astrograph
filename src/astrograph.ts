...
function usage() {
  ...
  [
    ...
    "  astrograph install [--ide codex|copilot|copilot-cli|all|codex,copilot,...] [--repo /abs/repo] [--yes] [--scope global|repository] [--channel latest|snapshot] [--reset] [--agents] [--git-hooks] [--dry-run] [--json]",
